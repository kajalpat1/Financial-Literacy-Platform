...
// Spending simulation (linear accumulation)
...
const BudgetScenario = () => {
  ...
  useEffect(() => {
    ...
    const selected = urlParams.get('type') || 'save';
    const rate = parseFloat(urlParams.get('rate')) || (selected === 'invest' ? 8 : 5);
    const value = parseFloat(urlParams.get('value')) || 5000;
  ...
  return (
    <div className="page page--scenario">
      <h2 style={{ marginBottom: '1rem', textAlign: 'center' }}>Poll Visualization</h2>
